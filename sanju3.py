...
def main():
    ...
    with open(output_csv_file, mode='w', newline='', encoding='utf-8') as csv_file:
        fieldnames = ['IP Address', 'Location', 'Status', 'Last Analysis Date', 'Detection Details', 'Community Score', 'IP Block', 'ASN']
        ...
        for ip in ip_addresses:
            try:
                ...
                community_score = response_data.get('data', {}).get('attributes', {}).get('reputation', 'N/A')
